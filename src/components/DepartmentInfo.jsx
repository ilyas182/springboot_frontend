...
export default function DepartmentInfo() {
    ...
    return (
        <div className="p-8">
            ...
            <div>
            <a href="#" onClick={handleBackBtn} className="text-blue-500 hover:underline mr-4">Back</a>
            <span className="text-2xl mx-4">Page {page}</span>
            <a href="#" onClick={handleNextBtn} className="text-blue-500 hover:underline ml-4">Next</a>
            </div>
        </div>
    )
}